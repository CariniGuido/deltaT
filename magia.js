    ...
    navigator.geolocation.getCurrentPosition(posicion => {
      ...
      fetch(`https://api.openweathermap.org/data/2.5/onecall?lat=${latitud}&lon=${longitud}&exclude=minutely,hourly,daily&units=metric&appid=1421faa6896fd18ab715b2a75d3f01a1`)
        ...
        .then(data => {
          ...
          // Actualizar los valores de los diales con las mediciones
          temperaturaGauge.set(temperaturaActual);
          document.getElementById("temperatura-gauge").innerHTML = temperaturaActual.toFixed(1) + " °C";
      
          vientoGauge.set(vientoActual);
          document.getElementById("viento-gauge").innerHTML = vientoActual.toFixed(1) + " km/h";
      
          humedadGauge.set(humedadActual);
          document.getElementById("humedad-gauge").innerHTML = humedadActual.toFixed(1) + " %";
        });
    });
  }
